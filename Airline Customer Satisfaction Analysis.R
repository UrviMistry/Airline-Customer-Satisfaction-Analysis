...
# Replacing NA's in departure dealy in minutes by mean
...
ggplot(data_s,aes(x=age,y=satisfaction))+geom_count()+stat_summary(aes(y =data_s$satisfaction ,group=1), fun.y=mean, colour="blue", geom="line",group=1)

ggplot(data_a,aes(x=age,y=satisfaction))+geom_count()+stat_summary(aes(y =data_a$satisfaction ,group=1), fun.y=mean, colour="red", geom="line",group=1)

ggplot(data_s,aes(x=gender,y=satisfaction))+geom_count()+stat_summary(aes(y =data_s$satisfaction ,group=1), fun.y=mean, colour="blue", geom="point",group=1)

ggplot(data_a,aes(x=gender,y=satisfaction))+geom_count()+stat_summary(aes(y =data_a$satisfaction ,group=1), fun.y=mean, colour="red", geom="point",group=1)

ggplot(data_s,aes(x=type_of_travel,y=satisfaction))+geom_count()+stat_summary(aes(y =data_s$satisfaction ,group=1), fun.y=mean, colour="blue", geom="line",group=1)

ggplot(data_a,aes(x=type_of_travel,y=satisfaction))+geom_count()+stat_summary(aes(y =data_a$satisfaction ,group=1), fun.y=mean, colour="red", geom="line",group=1)

ggplot(data_s,aes(x=class,y=satisfaction))+geom_count()+stat_summary(aes(y =data_s$satisfaction ,group=1), fun.y=mean, colour="blue", geom="line",group=1)

ggplot(data_a,aes(x=class,y=satisfaction))+geom_count()+ stat_summary(aes(y =data_a$satisfaction ,group=1), fun.y=mean, colour="red", geom="line",group=1)

# Satisfaction Vs Airline Status
ggplot(data_s,aes(x=airline_status,y=satisfaction))+geom_count()+ stat_summary(aes(y =data_s$satisfaction ,group=1), fun.y=mean, colour="blue", geom="line",group=1)

ggplot(data_a,aes(x=airline_status,y=satisfaction))+geom_count()+ stat_summary(aes(y =data_a$satisfaction ,group=1), fun.y=mean, colour="red", geom="line",group=1)

# Satisfaction Vs No of flights per annum
ggplot(data_s,aes(x=no_of_flights_per_annum,y=satisfaction))+geom_count()+stat_summary(aes(y =data_s$satisfaction ,group=1), fun.y=mean, colour="blue", geom="point",group=1)

ggplot(data_a,aes(x=no_of_flights_per_annum,y=satisfaction))+geom_count()+stat_summary(aes(y =data_a$satisfaction ,group=1), fun.y=mean, colour="red", geom="point",group=1)
...
ggplot(data_s,aes(x=year_of_first_flight,y=satisfaction))+geom_count(aes(color = ..n..))+stat_summary(aes(y=data_s$satisfaction ,group=1), fun.y=mean, colour="red", geom="line",group=1)
...
ggplot(data_s,aes(x=shopping_amount_at_airport,y=satisfaction))+geom_count()+stat_summary(aes(y=data_s$satisfaction ,group=1), fun.y=mean, colour="red", geom="point",group=1)

ggplot(data_a,aes(x=shopping_amount_at_airport,y=satisfaction))+geom_count()+stat_summary(aes(y=data_a$satisfaction ,group=1), fun.y=mean, colour="blue", geom="point",group=1)

ggplot(data_s,aes(x=eat_drink_at_airport,y=satisfaction))+geom_count()+stat_summary(aes(y=data_s$satisfaction ,group=1), fun.y=mean, colour="red", geom="point",group=1)

ggplot(data_a,aes(x=eat_drink_at_airport,y=satisfaction))+geom_count()+stat_summary(aes(y=data_a$satisfaction ,group=1), fun.y=mean, colour="blue", geom="point",group=1)

ggplot(data_s,aes(x=departure_delay_in_minutes,y=satisfaction))+geom_count()+stat_summary(aes(y=data_s$satisfaction ,group=1), fun.y=mean, colour="red", geom="point",group=1)

ggplot(data_a,aes(x=departure_delay_in_minutes,y=satisfaction))+geom_count()+stat_summary(aes(y=data_a$satisfaction ,group=1), fun.y=mean, colour="blue", geom="point",group=1)

ggplot(data_s,aes(x=arrival_delay_in_minutes,y=satisfaction))+geom_count()+stat_summary(aes(y=data_s$satisfaction ,group=1), fun.y=mean, colour="red", geom="point",group=1)

ggplot(data_a,aes(x=arrival_delay_in_minutes,y=satisfaction))+geom_count()+stat_summary(aes(y=data_a$satisfaction ,group=1), fun.y=mean, colour="blue", geom="point",group=1)

ggplot(data_s,aes(x=flight_time_in_minutes,y=satisfaction))+geom_count(aes(color = ..n..))+stat_summary(aes(y=data_s$satisfaction ,group=1), fun.y=mean, colour="red", geom="point",group=1)

ggplot(data_a,aes(x=flight_time_in_minutes,y=satisfaction))+geom_count(aes(color = ..n..))+stat_summary(aes(y=data_a$satisfaction ,group=1), fun.y=mean, colour="blue", geom="point",group=1)

ggplot(data_s,aes(x=flight_distance,y=satisfaction))+geom_count()+stat_summary(aes(y=data_s$satisfaction ,group=1), fun.y=mean, colour="red", geom="point",group=1)

ggplot(data_a,aes(x=flight_distance,y=satisfaction))+geom_count()+stat_summary(aes(y=data_a$satisfaction ,group=1), fun.y=mean, colour="blue", geom="point",group=1)

ggplot(data_s,aes(x=arrival_delay_greater_than_5_minutes,y=satisfaction))+geom_count(aes(color = ..n..))+stat_summary(aes(y=data_s$satisfaction ,group=1), fun.y=mean, colour="red", geom="line",group=1)

ggplot(data_a,aes(x=arrival_delay_greater_than_5_minutes,y=satisfaction))+geom_count(aes(color = ..n..))+stat_summary(aes(y=data_a$satisfaction ,group=1), fun.y=mean, colour="blue", geom="line",group=1)

ggplot(data_s,aes(x=day_of_month,y=satisfaction))+geom_count(aes(color = ..n..))+stat_summary(aes(y=data_s$satisfaction ,group=1), fun.y=mean, colour="red", geom="line",group=1)

ggplot(data_a,aes(x=day_of_month,y=satisfaction))+geom_count(aes(color = ..n..))+stat_summary(aes(y=data_a$satisfaction ,group=1), fun.y=mean, colour="blue", geom="line",group=1)
